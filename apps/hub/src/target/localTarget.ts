...
export const localTarget: Target = {
  ...
  packagesList: () => invoke<Package[]>("pkg_list"),
  packagesUpgradable: () => invoke<Package[]>("pkg_upgradable"),
  packagesSearch: (query) => invoke<Package[]>("pkg_search", { query }),
  packageInstall: (id) => invoke<PackageActionResult>("pkg_install", { id }),
  packageUninstall: (id) => invoke<PackageActionResult>("pkg_uninstall", { id }),
