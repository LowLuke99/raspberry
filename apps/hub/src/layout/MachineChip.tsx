...
export function MachineChip() {
  ...
  const tintVar = active.isLocal ? "--raspberry-rgb" : "--purple-rgb";
  ...
  return (
    <li>
      ...
      >
        ...
        >
          <span className="grid h-6 w-6 place-items-center rounded-[6px] bg-surface-hi">
            {icon}
          </span>
